...
@section('content')
	...
	<!-- Product -->
	<section class="bg0 p-t-70 p-b-140">
		<div class="container">
		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button type="button"  class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{$category->name}}" >
						{{$category->name}}
					</button>
					@endforeach
