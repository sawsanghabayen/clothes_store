                ...
                <div class="gutter-b example example-compact">
                    ...
                    <div class="contentTabel">
                        ...
                        <div class="container box-filter-collapse" >
                            <div class="card" >
                                <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/banners')}}">
                                    <div class="row">
                                            <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="{{url(app()->getLocale().'/admin/banners')}}" type="submit" class="btn sbold btn-default btnRest">{{__('cp.reset')}}
                                ...
                                @forelse($banners as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/admin/banners/'.$one->id.'/edit')}}"
