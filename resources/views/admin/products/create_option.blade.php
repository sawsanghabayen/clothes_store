            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{__('cp.add_option')}} ( {{@$meal->user->name}} / {{$meal->title}} )</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form method="post" action="{{url(app()->getLocale().'/admin/meals/'.$meal->id.'/storeOption')}}"
                        ...
                        <div class="row col-sm-12">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-solid"
                                                ...
                                                <option
                                                    value="0" {{old('options_type') == '0' ?'selected' : ''}}>
                                                    {{__('cp.optional')}}
                                                </option>
                                                <option
                                                    value="1" {{old('options_type') == '1' ?'selected' : ''}}>
                                                    {{__('cp.mandatory')}}
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6" id="minimum_value" style="display: none">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6" id="maximum_value" style="display: none">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-solid select2"
                                                ...
                                                @foreach($option_values as $one)
                                                    <option value="{{$one->id}}" {{old('option_values.'.$loop->index)==$one->id?'selected':''}}> {{$one->name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
